...
## Project Structure
    ...
    ├── wandering_bonus_dev_89014  # Django project configurations
...
1. Clone this repo and `cd wandering_bonus_dev_89014`
...
2. Clone this repo and `cd wandering_bonus_dev_89014`
